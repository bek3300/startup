...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('wereda_name', models.CharField(max_length=30, verbose_name='Wereda Name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('airelated_expriance', models.CharField(max_length=50, verbose_name='AI Related Experience')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ownership', models.CharField(choices=[('Private', 'Private'), ('Public', 'Incubation'), ('NGO', 'NGO'), ('Government', 'Government'), ('Other', 'Other')], max_length=50, verbose_name='Owner Ship')),
                ('ownership_other', models.CharField(blank=True, max_length=50, null=True)),
                ('focusIndustry', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=500), default=list, size=None)),
                ...
                ('program_duration', models.CharField(blank=True, choices=[('less_than_3_month', 'less than 3 month'), ('3_to_6 months', '3 to 6 months'), ('6_months_to_a_year', '6 months to a year'), ('1_year_to_two_years', '1 year to two years'), ('International', 'International')], max_length=50, null=True, verbose_name='Program Duration')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[('pre', 'Pre-Startup'), ('mid', 'Mid-Startup'), ('early', 'Early Trsction'), ('market', 'In-Market')], max_length=50, verbose_name='Level')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doner_type_by_other', models.CharField(max_length=50)),
                ('level', models.CharField(choices=[('pre', 'Pre-Startup'), ('mid', 'Mid-Startup'), ('early', 'Early Trsction'), ('market', 'In-Market')], max_length=50, verbose_name='Level')),
